    ...
    <Box sx={{ padding: 1 }}>
      ...
      <ContentBox>
        <Box sx={{ paddingX: 2, textAlign: "initial", display: "inline-block" }}>
          <ul>
            <li>S + V + <HighlightSpan>to</HighlightSpan> + V<sub>1</sub> <sup>({tPage("not to is not used")})</sup></li>
      ...
      <ContentBox boxMargin>
        <Box sx={{ paddingX: 2, textAlign: "initial", display: "inline-block" }}>
          <ul>
            <li>S + V + <HighlightSpan>[so that / in order that]</HighlightSpan> + S + <HighlightSpan>[will/can]</HighlightSpan> <sup>({tPage("other tenses")})</sup> (+ not) + V<sub>1</sub></li>
            <li>S + V + <HighlightSpan>[so that / in order that]</HighlightSpan> + S + <HighlightSpan>[would/could]</HighlightSpan> <sup>({tPage("past tenses")})</sup> (+ not) + V<sub>1</sub></li>
          </ul>
        </Box>
      </ContentBox>
